...
def catch_pokemon(favorite):
    print("You caught a " + favorite + " HOT DOG!!")

catch_pokemon("Mr. Mime!")
...
#Let's re-write the catch pokemon function so it's more fun.  
# Delete the contents of the catch_pokemon function and the function's parameter.  
# Outside of the catch_pokemon FUNCTION, create a string input and assign it to a variable called pokemon.  
# For the input question, use the prompt "What did you catch?"  
