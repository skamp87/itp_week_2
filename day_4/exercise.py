...
# BONUS:  Include an option for adding tip through either a percentage amount assigned to a global varible, 
# or through a specific amount input by the user.  You may use the math module from the Python standard library.
...
#Break each part down to the smallest problem you can, and then address them individually.  
